...
class_name ComplexMessage_NestedMessage
...
func serialize() -> PackedByteArray:
	...
	if deep != null:
		bytes.append_array(encode_varint(26))
		var entry = PackedByteArray()
		entry.append_array(encode_value(deep.key))
		entry.append_array(encode_value(deep.value))
